...
class ExpansionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expansion" do
    assert_difference("Expansion.count") do
      post expansions_url, params: { expansion: { area_id: @expansion.area_id, name: @expansion.name, trade_id: @expansion.trade_id } }
    end
  ...
  test "should update expansion" do
    patch expansion_url(@expansion), params: { expansion: { area_id: @expansion.area_id, name: @expansion.name, trade_id: @expansion.trade_id } }
